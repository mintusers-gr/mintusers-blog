...
| addressable | URI Implementation<br/><a href='https://github.com/sporkmonger/addressable' target='_blank'>https://github.com/sporkmonger/addressable</a>|2.5.0|
| autoprefixer-rails | Parse CSS and add vendor prefixes to CSS rules using values from the Can I Use website.<br/><a href='https://github.com/ai/autoprefixer-rails' target='_blank'>https://github.com/ai/autoprefixer-rails</a>|6.7.6|
| bundler | The best way to manage your application's dependencies<br/><a href='http://bundler.io' target='_blank'>http://bundler.io</a>|1.14.6|
| chronic | Natural language date/time parsing.<br/><a href='http://github.com/mojombo/chronic' target='_blank'>http://github.com/mojombo/chronic</a>|0.10.2|
| coderay | Fast syntax highlighting for selected languages.<br/><a href='http://coderay.rubychan.de' target='_blank'>http://coderay.rubychan.de</a>|1.1.1|
| colorator | Colorize your text in the terminal.<br/><a href='https://github.com/octopress/colorator' target='_blank'>https://github.com/octopress/colorator</a>|1.1.0|
| colored | Add some color to your life.<br/><a href='http://github.com/defunkt/colored' target='_blank'>http://github.com/defunkt/colored</a>|1.2|
| concurrent-ruby | Modern concurrency tools for Ruby. Inspired by Erlang, Clojure, Scala, Haskell, F#, C#, Java, and classic concurrency patterns.<br/><a href='http://www.concurrent-ruby.com' target='_blank'>http://www.concurrent-ruby.com</a>|1.0.5|
| ethon | Libcurl wrapper.<br/><a href='https://github.com/typhoeus/ethon' target='_blank'>https://github.com/typhoeus/ethon</a>|0.10.1|
| execjs | Run JavaScript code from Ruby<br/><a href='https://github.com/rails/execjs' target='_blank'>https://github.com/rails/execjs</a>|2.7.0|
| exifr | Read EXIF from JPEG and TIFF images<br/><a href='http://github.com/remvee/exifr/' target='_blank'>http://github.com/remvee/exifr/</a>|1.2.5|
| extras | Add neat extras into your Ruby stuff.<br/><a href='http://github.com/envygeeks/extras' target='_blank'>http://github.com/envygeeks/extras</a>|0.1.0|
| faraday | HTTP/REST API client library.<br/><a href='https://github.com/lostisland/faraday' target='_blank'>https://github.com/lostisland/faraday</a>|0.11.0|
| fastimage | FastImage - Image info fast<br/><a href='http://github.com/sdsykes/fastimage' target='_blank'>http://github.com/sdsykes/fastimage</a>|2.1.0|
| ffi | Ruby FFI<br/><a href='http://wiki.github.com/ffi/ffi' target='_blank'>http://wiki.github.com/ffi/ffi</a>|1.9.18|
| font-awesome-sass | Font-Awesome SASS<br/><a href='https://github.com/FortAwesome/font-awesome-sass' target='_blank'>https://github.com/FortAwesome/font-awesome-sass</a>|4.7.0|
| forwardable-extended | Forwardable with hash, and instance variable extensions.<br/><a href='http://github.com/envygeeks/forwardable-extended' target='_blank'>http://github.com/envygeeks/forwardable-extended</a>|2.6.0|
| fspath | Better than Pathname<br/><a href='http://github.com/toy/fspath' target='_blank'>http://github.com/toy/fspath</a>|3.0.3|
| gemoji | Emoji library<br/><a href='https://github.com/github/gemoji' target='_blank'>https://github.com/github/gemoji</a>|3.0.0|
| html-pipeline | Helpers for processing content through a chain of filters<br/><a href='https://github.com/jch/html-pipeline' target='_blank'>https://github.com/jch/html-pipeline</a>|2.5.0|
| html-proofer | A set of tests to validate your HTML output. These tests check if your image references are legitimate, if they have alt tags, if your internal links are working, and so on. It's intended to be an all-in-one checker for your documentation output.<br/><a href='https://github.com/gjtorikian/html-proofer' target='_blank'>https://github.com/gjtorikian/html-proofer</a>|3.5.0|
| i18n | New wave Internationalization support for Ruby<br/><a href='http://github.com/svenfuchs/i18n' target='_blank'>http://github.com/svenfuchs/i18n</a>|0.8.1|
| image_optim | Optimize (lossless compress, optionally lossy) images (jpeg, png, gif, svg) using external utilities (advpng, gifsicle, jhead, jpeg-recompress, jpegoptim, jpegrescan, jpegtran, optipng, pngcrush, pngout, pngquant, svgo)<br/><a href='http://github.com/toy/image_optim' target='_blank'>http://github.com/toy/image_optim</a>|0.24.2|
| image_optim_pack | Precompiled binaries for image_optim: advpng, gifsicle, jhead, jpeg-recompress, jpegoptim, jpegtran, optipng, pngcrush, pngquant<br/><a href='http://github.com/toy/image_optim_pack' target='_blank'>http://github.com/toy/image_optim_pack</a>|0.3.1.20170121|
| image_size | Measure image size using pure Ruby<br/><a href='http://github.com/toy/image_size' target='_blank'>http://github.com/toy/image_size</a>|1.5.0|
| in_threads | Execute ruby code in parallel<br/><a href='http://github.com/toy/in_threads' target='_blank'>http://github.com/toy/in_threads</a>|1.3.1|
| jekyll | A simple, blog aware, static site generator.<br/><a href='https://github.com/jekyll/jekyll' target='_blank'>https://github.com/jekyll/jekyll</a>|3.4.1|
| jekyll-assets | Assets for Jekyll<br/><a href='http://github.com/jekyll/jekyll-assets/' target='_blank'>http://github.com/jekyll/jekyll-assets/</a>|2.2.8|
| jekyll-compose | Streamline your writing in Jekyll with these commands.<br/><a href='https://github.com/jekyll/jekyll-compose' target='_blank'>https://github.com/jekyll/jekyll-compose</a>|0.5.0|
| jekyll-feed | A Jekyll plugin to generate an Atom feed of your Jekyll posts<br/><a href='https://github.com/jekyll/jekyll-feed' target='_blank'>https://github.com/jekyll/jekyll-feed</a>|0.9.1|
| jekyll-gist | Liquid tag for displaying GitHub Gists in Jekyll sites.<br/><a href='https://github.com/jekyll/jekyll-gist' target='_blank'>https://github.com/jekyll/jekyll-gist</a>|1.4.0|
| jekyll-graphviz | A liquid tag to convert with Graphviz for Jekyll<br/><a href='https://github.com/kui/jekyll-graphviz' target='_blank'>https://github.com/kui/jekyll-graphviz</a>|0.1.0|
...
| thread_safe | Thread-safe collections and utilities for Ruby<br/><a href='https://github.com/ruby-concurrency/thread_safe' target='_blank'>https://github.com/ruby-concurrency/thread_safe</a>|0.3.6|
